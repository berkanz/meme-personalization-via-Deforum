...
def personalize_meme(templates, model_path, user_id, make_gif=False):
    ...
    for template in templates:
        master_args = load_file_args("templates/" + template)
        ...
        def DeforumArgs():
            ...
            grid_rows = 2 #@param 
            outdir = get_output_folder(root.output_path, user_id)
